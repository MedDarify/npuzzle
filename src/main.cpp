...
int main(int argc, char** argv) {
    ...
    try {
        ...
        if (algoFlag == "hamming") {
            std::cout << "Using Heuristic: Hamming Distance" << std::endl;
            hFunc = Heuristics::calculateHamming;
        } 
        else if (algoFlag == "linear") {
            std::cout << "Using Heuristic: Linear Conflict" << std::endl;
            hFunc = Heuristics::calculateLinearConflict;
        } 
        else {
            std::cout << "Using Heuristic: Manhattan Distance" << std::endl;
